...
- (void)_setupFileBubbleMarginConstraints {
    ...
    // icon view
    NSLayoutConstraint *fileIconWithMarginTopConstraint =
            [NSLayoutConstraint constraintWithItem:self.fileIconView
    ...
    NSLayoutConstraint *fileIconWithMarginBottomConstraint =
            [NSLayoutConstraint constraintWithItem:self.fileIconView
    ...
    NSLayoutConstraint *fileIconWithMarginLeftConstraint =
            [NSLayoutConstraint constraintWithItem:self.fileIconView
    ...
    // name label
    NSLayoutConstraint *fileNameWithMarginTopConstraint =
            [NSLayoutConstraint constraintWithItem:self.fileNameLabel
                                         attribute:NSLayoutAttributeTop
                                         relatedBy:NSLayoutRelationEqual
                                            toItem:self.backgroundImageView
                                         attribute:NSLayoutAttributeTop
                                        multiplier:1.0
                                          constant:self.margin.top];
    NSLayoutConstraint *fileNameWithMarginRightConstraint =
            [NSLayoutConstraint constraintWithItem:self.fileNameLabel
    ...
    // size label
    NSLayoutConstraint *fileSizeWithMarginBottomConstraint =
            [NSLayoutConstraint constraintWithItem:self.fileSizeLabel
                                         attribute:NSLayoutAttributeBottom
                                         relatedBy:NSLayoutRelationEqual
                                            toItem:self.backgroundImageView
                                         attribute:NSLayoutAttributeBottom
...
- (void)_setupFileBubbleConstraints {
    ...
    // icon view
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.fileIconView
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.fileSizeLabel
                                                     attribute:NSLayoutAttributeLeft
                                                     relatedBy:NSLayoutRelationEqual
